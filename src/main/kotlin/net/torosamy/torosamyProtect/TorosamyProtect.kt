...
class TorosamyProtect : JavaPlugin() {
    ...
    override fun onEnable() {
        ...
        if(isUseRes) Bukkit.getConsoleSender().sendMessage(MessageUtil.format ("&b[服务器娘]&a插件 &eTorosamyProtect &a检测到 &eResidence &a开启"))
        else Bukkit.getConsoleSender().sendMessage(MessageUtil.format ("&b[服务器娘]&c插件 &eTorosamyProtect &c检测到 &eResidence &c未开启"))
        ...
        Bukkit.getConsoleSender().sendMessage(MessageUtil.format ("&b[服务器娘]&a插件 &eTorosamyProtect &a成功开启喵~"))
